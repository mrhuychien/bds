 ...
 * @param suffix - Optional suffix to append (e.g., ID)
...
/**
 * Generate property slug with short ID
 * @param title - Property title
 * @returns Unique property slug
 */
export function generatePropertySlug(title: string): string {
  return generateSlug(title, generateShortId(8))
}
